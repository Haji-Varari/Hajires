<?php
session_start();
$nameErr = $emailErr = $notesErr = $addressErr = $contactErr = $usernameErr = $passwordErr = "";
$name  = $address = $contact = $uname = $upassword = "";
$cID;
								...
								$conn = new mysqli($servername, $username, $password); 
										if ($conn->connect_error) {
											...
											$id = $row['UserID'];
													...
													$sql = "INSERT INTO customer(CustomerName, CustomerPhone, CustomerAddress, CustomerNotes, UserID) 
													VALUES('".$name."', '".$contact."', '".$address."', '".$notes."', ".$id.")";
													$conn->query($sql);
...
<form method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	Mobile Number:<br><input type="text" name="contact" placeholder="0123456789">
    ...
    <textarea name="notes" cols="50" rows="5" placeholder="Notes"></textarea>
    <span class="error" style="color: red; font-size: 0.8em;"><?php echo $addressErr;?></span><br><br>
