...
echo '<blockquote>';
    ...
    while($row = $result->fetch_assoc()) {
	    echo "<td>";
	    echo "<table>";
	   	echo '<tr><td>'.'<img src="'.$row["Image"].'"width="80%">'.'</td></tr><tr><td style="padding: 5px;">Item Name: '.$row["FoodName"].'</td></tr><tr><td style="padding: 5px;">Calories: '.$row["Calories"].'</td></tr><tr><td style="padding: 5px;">Rs.'.$row["Price"].'</td></tr><tr><td style="padding: 5px;">
